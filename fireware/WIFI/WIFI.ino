...
// ===================== 基础配置（首次烧录需修改）=====================
#define DEFAULT_WIFI_SSID "TP-LINK_5A00"  // 初始2.4G WiFi账号
#define DEFAULT_WIFI_PWD  "13783049779"   // 初始2.4G WiFi密码
...
const char* MQTT_BROKER = "mb300ee7.ala.cn-hangzhou.emqxsl.cn"; // EMQX云端地址
